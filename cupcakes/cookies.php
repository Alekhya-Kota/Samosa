...
<html>
 ...
 <body background="images/bg6.jpg">
   ...
   <div class="images">
   <div class="images">
      <div style="position:relative;width:200px;height:1200px;border: 0px solid grey;padding: 10px;margin: 10">
	  <div style="position:relative;width:200px;height:1200px;border: 0px solid grey;padding: 10px;margin: 10">
<table style="font-size:30px;height:10em">
	  <tr><th>Sort by Price</th></tr><tr></tr><tr></tr>
  <tr><th><a href="cookies6.php" style="text-decoration:none;color:red;">High to Low</a></th></tr><tr></tr><tr></tr>
  <tr><th><a href="cookies7.php" style="text-decoration:none;color:red;">Low to High</a></th></tr><tr></tr><tr></tr>
  <tr><th><a href="cookies8.php" style="text-decoration:none;color:red;">Below 20$</a></th></tr><tr></tr><tr></tr>
  <tr><th><a href="cookies9.php" style="text-decoration:none;color:red;">Above 20$</a></th></tr><tr></tr><tr></tr>
<tr><th><a href="cookies23.php" style="text-decoration:none;color:red;">Search</a></th></tr><tr></tr><tr></tr>
		 
	 </table>
   <div style="position:relative;left:220px;width:900px;height:1300px;border: 0px solid grey;padding: 10px;margin: 10;top:-320px;">
     <form action="addtocart.php" method="post">
	 <table>
	 <tr><th><font color='red' size=6>Cookies</font></th></tr>
	 <tr>
	 <?php
	  
$type="cookies";
$con=mysqli_connect("localhost", "root", "","cupcakes")or die("cannot connect"); $res=mysqli_query($con,"select * from product_details where pd_type='$type' ");
$count=0;
while($next_row=mysqli_fetch_row($res)){
	...
	<th><img src='<?php echo $next_row[5] ?>' hspace="20" vspace="20" width=200 height=200 style="border:0px solid grey;"/><br>
