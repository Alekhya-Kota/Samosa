...
<html>
 ...
 <body background="images/bg6.jpg">
  ...
  <div style="position:relative;left:100px;width:1100px;height:440px;border: 0px solid grey;padding: 10px;margin: 10;top:-10px;">
	...
	<tr>
	<th><font size=6 color="red"> Boston Cream Pie</font></th></tr>
	<tr><th><img src="images/boston.jpg"></th></tr>
	<tr>
	<th><font size=5 color="blue">A Boston cream pie is a cake that is filled with a custard or cream filling and frosted with chocolate.[1] Although it is called a Boston cream pie, it is in fact a cake, and not a pie.</th>
    </tr>
</table><p>
