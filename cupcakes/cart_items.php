      ...
      if(!empty($_SESSION["cart_item"])) {
        ...
        <table class="imagetable">
          ...
          foreach($_SESSION["cart_item"] as $k => $v) {
              if(!empty($_SESSION["cart_item"][$k]["product_name"])) {
                $totalPrice = $totalPrice +$_SESSION["cart_item"][$k]["total"];
                    echo "<tr>";
                    echo "<td> <b>".$_SESSION["cart_item"][$k]["product_name"]."</b></td>";
                    ...
                    echo "<td> <a href='cart_items.php?action=remove&model_id=".$_SESSION["cart_item"][$k]["pd_id"]."'>Remove Item </a></td>";
                    echo "</tr>";
              }
            }
            echo "</table>";
            ...
            <a href="http://localhost/cupcakes/userhome.php">Continue Shopping</a><br><br>
          <?php
            }
          ?>
