...
<html>
 ...
 <body>
   ...
   <span style="color:blue;float:right;font-size:20px"><font  >Welcome to <?php echo $_SESSION['username'] ?><br>
   <a href="userlogout.php">Logout</a></font></span>
...
if (session_status() == PHP_SESSION_ACTIVE) {
  ...
  //$res=mysql_query($con,"select * from product_details where pd_type='$type' ");
$res=mysqli_query($con,"select * from product_details where pd_type='$type' and pd_name='$selected' ");
...
<form method="post">
	...
	<th>
	<select id="qnt" onChange="calculate(this.value)">
	<option value="0">0
	<option value="1">1
	<option value="2">2
	<option value="3">3
