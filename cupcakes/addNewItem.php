...
<html>
 ...
 <body>
   ...
   <span style="color:blue;float:right;font-size:20px"><font  >Welcome to Admin<br><a href="admin.php">Logout&nbsp;&nbsp;&nbsp;</a>
   <a href="adminhome.php">Back</a>
   </font></span>
   <form action="newitem.php" method="post" enctype="multipart/form-data">  
		<Fieldset><legend><font color="blue" size=6>Add Details</legend>
<table class="admin_log_table" align="center">
		...
		<tr>
		<th>Price:</th>
		<th><input type="text" name="price" placeholder=" price " required/></th>
		</tr>
		<tr>
		<th>Type:</th>
		<th>
		  <select name="pro_type" >
		  <option value="cupcakes">CupCakes
		  <option value="cookies">Cookies
		  <option value="cakes">Cakes
		</th>
		</tr>
		<tr>
		<th>Description</th>
		<th><textarea cols=20 rows=10 name="desc"></textarea></th>
		</tr>
		<tr>
		<th>Image</th>
