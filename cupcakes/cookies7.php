...
$type="cookies";
$_SESSION['type']=$type;
$con=mysqli_connect("localhost", "root", "","cupcakes")or die("cannot connect"); $res=mysqli_query($con,"select * from product_details where pd_type='$type' order by pd_price asc ");
$count=0;
