...
<tr><th colspan=6><font color="green">Successfully deleted</font></th></tr>
<tr>
<th>Name</th>
<th>Price</th>
<th>Type</th>
...
$con=mysqli_connect("localhost", "root", "","cupcakes")or die("cannot connect"); $res=mysqli_query($con,"SELECT * FROM product_details");
?>
